-- ============================================================
-- Mizan Platform — security_ui_elements seed (4-language)
-- ============================================================
...
insert into security_ui_elements (key, node, ar, fr, en, es) values
  ...
  ('security_description', 'security_dashboard_texts',
    'يتم تشفير جميع ملفات السيرة الذاتية (Resumes) والوثائق المرفوعة على منصة ميزان تلقائياً باستخدام بروتوكول AES-256 قبل تخزينها في Cloudflare D1 وSupabase Storage. كلمات المرور يتم تحويلها إلى هاش مشفر غير قابل للتراجع، مما يضمن أماناً مطلقاً لحسابك.',
