...
import { canonicalLexicon, canonicalUrl, lexiconSlug } from "../shared/seo/url-policy.js";
...
// lexiconSlug() من سياسة الروابط، بمجموعة تكرار واحدة وبنفس ترتيب prerender:
// أي فرق هنا يُنشئ رابط معجم في قائمة الكليات لا ملف تحته.
const seen = new Set();
const rows = terms.map((x) => ({ ...x, s: lexiconSlug(x, seen) }));
