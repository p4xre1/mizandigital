...
const pages = [
  {
    path: "/",
    title: "ميزان الرقمية | المعرفة القانونية للطلبة بالمغرب",
    ...
    staticBody: `
      <main dir="rtl" lang="ar-MA">
        <article>
          ...
          <p>
            <strong>
              الأرشيف الدراسي هو القسم المخصص للوصول إلى المواد التعليمية
...

  {
    ...
    description:
      "مقالات ومنهجيات ومهارات قانونية موجهة لطلبة الحقوق والباحثين.",
    staticBody: `
      <main dir="rtl" lang="ar-MA">
        <article>
          ...
          <p>
            <strong>
              هذا القسم يجمع المقالات والمنهجيات التي تساعد الطالب
  ...
  {
    path: "/news",
    title: "الأخبار القانونية والأكاديمية | ميزان الرقمية",
    description:
      "آخر الأخبار والمستجدات القانونية والأكاديمية المتعلقة بالمغرب وطلبة الحقوق.",
    staticBody: `
      <main dir="rtl" lang="ar-MA">
        <article>
          <h1>الأخبار القانونية والأكاديمية</h1>
  ...
  {
    path: "/lexicon",
    title: "القاموس القانوني العربي الفرنسي | ميزان الرقمية",
    description:
...
pages.push(
...

  {
    ...
    description:
      "إجابات عن الأسئلة الشائعة حول ميزان الرقمية والقاموس والأرشيف.",
    schema: {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "ما هي ميزان الرقمية؟",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "ميزان الرقمية منصة عربية مغربية للمعرفة القانونية والأكاديمية موجهة لطلبة الحقوق والباحثين.",
          },
        },
        {
          "@type": "Question",
          name: "ماذا يحتوي القاموس القانوني؟",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              `يحتوي القاموس حالياً على ${statistics.lexicon} مصطلحاً في البيانات المنشورة.`,
          },
        },
        {
          "@type": "Question",
          name: "هل ميزان الرقمية مصدر قانوني رسمي؟",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "ميزان الرقمية منصة تعليمية وبحثية وليست بديلاً عن النصوص القانونية الرسمية.",
          },
        },
      ],
    },
    ...
    staticBody: `
      <main dir="rtl" lang="ar-MA">
        <article>
          ...
          <h2>ما هي ميزان الرقمية؟</h2>
          <p>
            ميزان الرقمية منصة عربية مغربية للمعرفة القانونية
            والأكاديمية موجهة لطلبة الحقوق والباحثين.
          </p>

          <h2>ماذا يحتوي القاموس القانوني؟</h2>
          <p>
            يحتوي القاموس حالياً على
            <strong>${statistics.lexicon} مصطلحاً</strong>
            في البيانات المنشورة.
          ...
          <h2>هل ميزان الرقمية مصدر قانوني رسمي؟</h2>
          <p>
            لا. المنصة تعليمية وبحثية، وينبغي الرجوع إلى
            النص القانوني الرسمي عند التحقق من القاعدة القانونية.
          </p>
  ...
  {
    path: "/cookies",
    title: "سياسة ملفات الارتباط | ميزان الرقمية",
    description:
      "معلومات حول استخدام ملفات الارتباط والتقنيات المشابهة.",
    staticBody: `
      <main dir="rtl" lang="ar-MA">
        <article>
