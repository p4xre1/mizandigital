  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        {/* Visual Icon Header */}
        <div className="w-20 h-20 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
          <Scale size={36} className="text-primary opacity-60" aria-hidden="true" />
        </div>
        ...
        {/* Descriptive Message */}
        <p
          className="text-slate-600 dark:text-slate-300 text-sm mb-8 leading-relaxed"
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 border border-border text-slate-700 dark:text-slate-200 bg-card rounded-xl hover:border-primary hover:text-primary transition-colors text-sm min-h-[44px]"
            style={{ fontFamily: sansFont(lang) }}
          >
