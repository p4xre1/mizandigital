...
import type { Role, Tier, UserProfile } from "../../types/database";
...
export function useRole(): UseRoleResult {
  ...
  // 1. Original Role Mappings
  const isPremium = useMemo(() => role === "premium_member" || role === "root", [role]);
