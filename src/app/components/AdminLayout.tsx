...
// 🛡️ NAV is defined AFTER all icon imports
const NAV: NavItem[] = [
        ...
        {open && (
          ...
          >
            <aside
              ...
              className="absolute top-14 bottom-0 start-0 w-64 bg-card p-4 border-e border-border shadow-2xl transition-transform"
