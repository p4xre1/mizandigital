...
export interface Database {
  public: {
    Tables: {
      ...
      seminars: { Row: { id: string; title: string; speaker: string; speaker_title: string | null; video_url: string; event_date: string | null; event_time: string | null; agenda: string | null; attachment_url: string | null; image_url: string | null; status: string | null; created_at: string | null }; Insert: any; Update: any; Relationships: [] }
