...
export interface Database {
  public: {
    Tables: {
      ...
      news: { Row: { id: string; title: string; summary: string | null; content: string | null; source: string | null; source_url: string | null; image_url: string | null; is_published: boolean | null; published_at: string | null; slug: string; created_at: string | null; views_count: number | null }; Insert: any; Update: any; Relationships: [] }
      schools: {
