...
export default function PagesManagementPage() {
  ...
  const pages: StaticPage[] = [
    ...
    { key: "cookies", label: "سياسة الكوكيز", path: "/cookies", icon: Settings, status: "updated", lastUpdated: "15 شتنبر 2026", description: "بلا Adsterra + __clerk_*, sb-*, mizan:subscription:v1, mizan:saved:content:v1, mizan_quiz_progress", seo: "AEOHead + directAnswer + FAQ", aeo: true, hasAdmin: false },
    ...
    <div className="space-y-6 p-6" dir="rtl">
      ...
      <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-5">
        ...
        <ul className="mt-3 list-disc pr-5 text-[11px] leading-6 text-muted-foreground">
          ...
          <li>كوكيز جديدة: __clerk_*, sb-*, mizan:subscription:v1, mizan:saved:content:v1, mizan_quiz_progress (D-SSS), mizan:analytics:queue</li>
