      ...
      <main className="container mx-auto max-w-3xl px-4 py-10 md:py-14" dir="rtl">
        ...
        <div className="space-y-8">
          ...
          <Section title="8. الإعلانات">
            <p>
              تعرض المنصة إعلانات عبر شبكات إعلانية خارجية (مثل Adsterra) كمصدر تمويل لاستمرارية تقديم المحتوى مجاناً.
              هذه الإعلانات تديرها وتختار محتواها الشبكة الإعلانية وشركاؤها، ولا تتحمل المنصة أي
