  ...
  return (
    <>
      <AEOHead
        ...
        breadcrumbs={[{ name: "الرئيسية", url: "/" }, { name: "الندوات والفعاليات القانونية بالمغرب", url: "/events" }]}
        keywords={[
          "ندوات قانونية",
      ...
      <main className="container mx-auto max-w-6xl px-4 py-10" dir="rtl">
        ...
        <header className="mb-8 text-center md:text-right">
          ...
          <p className="mt-2 text-base text-muted-foreground max-w-2xl">
            متابعة حية للندوات القانونية، المؤتمرات العلمية، والأيام الدراسية المنظمة بكليات الحقوق بالمغرب، مع إمكانية مشاهدة التسجيلات والوثائق المرافقة لكل فعالية.
          </p>
        </header>
