...
export default function MinisterialDecrees() {
  ...
  return (
    ...
    >
      <div className="border-b border-border pb-4">
        ...
        >
          <FileCheck2 className="text-primary" size={32} />
          <span>
            {lang === "fr"
      ...
      <div className="p-8 border border-dashed border-border rounded-2xl text-center text-muted-foreground bg-card/40">
        <p className="text-lg font-medium">
          {lang === "fr"
            ? "Section Décrets Ministériels"
            : lang === "en"
            ? "Ministerial Decrees Section"
            : "قسم المراسيم والقرارات الوزارية"}
        </p>
      </div>
    </div>
  );
