...
/**
 * 🔄 Automatic Recovery for Stale Asset Chunks
 * Handles dynamic import failures when asset hashes change during production deployments.
 */
function handleVitePreloadError(): void {
  if (typeof window === "undefined") return;
  
  window.addEventListener("vite:preloadError", () => {
    // Automatically reloads the page so the browser gets the latest index.html and chunk URLs
