...
const txt = {
  ...
  adFinished: t4(
    "انتهى الإعلان. جاري المعالجة...",
    "Annonce terminée. Traitement...",
    "Ad finished. Processing...",
    "Anuncio finalizado. Procesando..."
  ),
  readyToWatch: t4(
    "جاهز للمشاهدة.",
    "Prêt à visionner.",
  ...
  errorFallback: t4(
    "فشل إضافة النقاط.",
    "Échec de l'ajout des crédits.",
    "Failed to add credits.",
    "Error al agregar créditos."
  ),
  processingCredit: t4(
    "جاري إضافة الرصيد...",
...
export default function WatchAdForCredit({
  ...
  // Handle completion trigger when progress reaches 100%
  useEffect(() => {
  ...
  const processAdCompletion = useCallback(
  ...
  return (
    ...
    >
      ...
      {loading && (
        <div
          className="flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400 pt-1"
          style={{ fontFamily: sansFont(lang) }}
        >
