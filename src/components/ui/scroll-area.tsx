...
const ScrollArea = React.forwardRef<ScrollAreaElement, ScrollAreaProps>(
  (
    ...
    ref: React.ForwardedRef<ScrollAreaElement>
  ): React.JSX.Element => (
...
const ScrollBar = React.forwardRef<ScrollBarElement, ScrollBarProps>(
  (
    ...
    ref: React.ForwardedRef<ScrollBarElement>
  ): React.JSX.Element => (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        ...
        orientation === "vertical" &&
          "h-full w-2.5 ltr:border-l ltr:border-l-transparent rtl:border-r rtl:border-r-transparent",
