...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("flex flex-col gap-1.5 p-4 ltr:text-left rtl:text-right", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("mt-auto flex flex-col gap-2 p-4 ltr:text-left rtl:text-right", className)}
    {...props}
  />
));
