...
const AccordionItem = React.forwardRef<AccordionItemElement, AccordionItemProps>(
  ({ className, ...props }: AccordionItemProps, ref: React.ForwardedRef<AccordionItemElement>) => (
...
const AccordionTrigger = React.forwardRef<AccordionTriggerElement, AccordionTriggerProps>(
  ({ className, children, ...props }: AccordionTriggerProps, ref: React.ForwardedRef<AccordionTriggerElement>) => (
...
const AccordionContent = React.forwardRef<AccordionContentElement, AccordionContentProps>(
  ({ className, children, ...props }: AccordionContentProps, ref: React.ForwardedRef<AccordionContentElement>) => (
