      ...
      <div className="container-wide flex flex-col gap-3 py-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <p className="text-xs leading-relaxed text-muted-foreground max-w-2xl">
            نستخدم ملفات تعريف الارتباط (الكوكيز) لأغراض تحليلية عبر Google Analytics لتحسين تجربة
            التصفح وفهم كيفية استخدامكم للمنصة. يمكنكم قبول ذلك أو رفضه، وسيبقى الموقع يعمل بشكل
            طبيعي في الحالتين. لمزيد من التفاصيل راجعوا{" "}
