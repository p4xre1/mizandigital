...
export const UTILITY_ROUTES = {
  ...
  "/payments": {
    ...
    description:
      "أدرِ رصيد الكريدتس المستعمل في خدمات الذكاء الاصطناعي وفواتير اشتراك ميزان برو داخل المنصة. الأسعار والحزم معروضة للعامة في صفحة الأسعار بلا تسجيل دخول.",
  },
  "/search": {
  ...
  "/pro-tools": {
    ...
    description:
      "أدوات ميزان برو داخل منصة ميزان الرقمية: مراجعة النصوص وتلخيصها بالذكاء الاصطناعي تتطلب اشتراكاً نشطاً. القاموس والأرشيف والمقالات تبقى مجانية للجميع.",
  },
};
